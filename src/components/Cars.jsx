    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {slicedData.map((sport) => (
          <div key={sport._id} className="bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 p-4">
              <img src={sport.img} alt={sport.name} className="w-full h-48 object-cover rounded-xl mb-4"/>
